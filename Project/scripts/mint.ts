...
// title: A script to mint the token
...
async function main() {
    ...
    if (process.argv.length < 5)  throw new Error("Voting power is missing"); 
    ...
    console.log(`voter at address : ${voterAddress} get voting power : ${amount} `);
